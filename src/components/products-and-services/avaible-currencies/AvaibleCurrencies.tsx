...
const avaibleCurrencies: AvaibleCurrencies = {
  ...
  imagesContext: [
    {
      text: "Coins",
      image: "images/products-and-service/lineOne.svg",
    },
    {
      text: "Stablekoins",
      image: "images/products-and-service/lineTwo.svg",
    },
    {
      text: "Tokens",
      image: "images/products-and-service/lineThree.svg",
    },
  ],
};
          ...
          <Fragment key={index}>
            ...
            <StyledGridItemRight>
              {!isMobile ? (
                ...
                <StyledImage
                  src={"images/products-and-service/line-S.svg"}
                  alt={item.text}
                />
              )}
            </StyledGridItemRight>
